  ...
  return (
    <div className={`relative flex items-center w-full ${className}`}>
      <input
        ...
        disabled={disabled}
        className={`w-full pl-3 pr-10 py-1.5 text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 dark:text-slate-200 transition-shadow ${disabled ? 'opacity-60 cursor-not-allowed bg-slate-50 dark:bg-slate-900/50' : ''}`}
