...
export const Button = React.forwardRef(({
  ...
  const variants = {
    primary: 'bg-bk-yellow hover:bg-[#ffd700] text-bk-side border border-bk-yellow/20 shadow-lg shadow-bk-yellow/5 active:scale-[0.98]',
    ...
    outline: 'border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-white/5 active:scale-[0.98]',
    ghost: 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 active:scale-[0.98]',
    danger: 'bg-rose-500 hover:bg-rose-600 text-white border border-rose-500/20 shadow-lg shadow-rose-500/10 active:scale-[0.98]',
  };
