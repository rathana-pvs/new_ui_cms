          ...
          <div className="relative border border-slate-200 dark:border-slate-800 rounded-xl p-3 pt-4 mt-2">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-primary/5 border border-primary/10 rounded-lg">
                <div className="space-y-1.5 text-[11px] leading-relaxed text-slate-500 dark:text-slate-400 font-normal">
                  <p className="italic">This utility reclaims space from two sources:</p>
