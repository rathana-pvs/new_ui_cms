    ...
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-bk-main overflow-hidden">
      ...
      <div className="flex-shrink-0 px-4 py-2.5 bg-white dark:bg-bk-side border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-[6px] bg-amber-50 dark:bg-amber-900/20 flex items-center justify-center">
            <span className="material-symbols-outlined text-amber-600 dark:text-bk-yellow text-[18px]">description</span>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
             ...
             className="p-1.5 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 rounded-[6px] transition-colors disabled:opacity-50"
