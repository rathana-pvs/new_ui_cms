    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#1e2230] w-full max-w-lg rounded shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
        ...
        {loading && (
          <div className="absolute inset-0 z-[110] flex items-center justify-center bg-white/80 dark:bg-[#1e2230]/80 backdrop-blur-sm">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-xs font-normal text-slate-500 dark:text-slate-400">Connecting...</span>
            </div>
          </div>
        )}
        ...
        <div className="p-4 space-y-4 bg-white dark:bg-[#1e2230]">
          ...
          <div className="relative border border-slate-200 dark:border-slate-800 rounded-xl p-3 pt-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <input 
                    ...
                    className={`w-full h-8 px-2 bg-white dark:bg-[#1a1d27] border ${errors.alias ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700'} rounded-lg focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/5 text-[12px] text-slate-900 dark:text-slate-100 transition-all font-normal`} 
                ...
                <div className="flex-1 flex gap-2">
                  <div className="flex-[2]">
                    <input 
                      ...
                      onChange={handleChange}
                      className={`w-full h-8 px-2 bg-white dark:bg-[#1a1d27] border ${errors.address ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700'} rounded-lg focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/5 text-[12px] text-slate-900 dark:text-slate-100 transition-all font-normal`} 
                  ...
                  <div className="flex-1">
                    <input 
                      ...
                      value={formData.port}
                      onChange={handleChange}
                      className={`w-full h-8 px-2 bg-white dark:bg-[#1a1d27] border ${errors.port ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700'} rounded-lg focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/5 text-[12px] text-slate-900 dark:text-slate-100 transition-all font-normal`} 
                      placeholder="8001" 
                      disabled={loading}
                    />
                  </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <input 
                    ...
                    value={formData.id}
                    onChange={handleChange}
                    className={`w-full h-8 px-2 bg-white dark:bg-[#1a1d27] border ${errors.id ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700'} rounded-lg focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/5 text-[12px] text-slate-900 dark:text-slate-100 transition-all font-normal`} 
              ...
              <div className="flex items-center gap-4">
                <label className="w-32 shrink-0 text-[11px] font-normal text-slate-500 dark:text-slate-400 text-left">Password :</label>
                <div className="flex-1">
                  <input 
                    type="password" 
                    name="password"
                    ...
                    onChange={handleChange}
                    className={`w-full h-8 px-2 bg-white dark:bg-[#1a1d27] border ${errors.password ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700'} rounded-lg focus:outline-none focus:border-primary/50 focus:ring-4 focus:ring-primary/5 text-[12px] text-slate-900 dark:text-slate-100 transition-all font-normal`} 
                    placeholder="••••••••" 
                    disabled={loading}
                  />
        ...
        <div className="px-6 py-2 bg-slate-50 dark:bg-[#1e2230] flex justify-end gap-3 border-t border-slate-100 dark:border-slate-800 flex-shrink-0">
          ...
          <button 
            disabled={loading}
            className="px-6 py-1.5 bg-primary hover:bg-primary/90 active:bg-primary/80 text-white text-xs rounded shadow transition-all flex items-center justify-center gap-2 min-w-[120px] font-normal disabled:opacity-50"
