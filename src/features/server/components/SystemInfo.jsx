...
export default function SystemInfo({ hostUid }) {
  ...
  return (
    <details className="group border border-slate-200 dark:border-slate-800 rounded-lg shadow-sm bg-white dark:bg-[#1a1d27] overflow-hidden" open>
      <summary className="flex items-center gap-2 px-3 py-2.5 cursor-pointer list-none hover:rose-100/50 dark:hover:rose-900/30 transition-colors bg-rose-50/50 dark:bg-rose-900/20 border-b border-rose-100 dark:border-rose-900/30 text-sm font-semibold text-slate-800 dark:text-slate-200">
      ...
      <div className="w-full px-4 py-3 text-xs font-mono text-slate-700 dark:text-slate-300 leading-relaxed">
        {!envData && !loading ? (
